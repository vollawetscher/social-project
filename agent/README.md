...
- **Inbound identity:** unidentified callers (or identified callers whose owner has no activated agent) are answered as the neutral **Notissima Agent**. A tier-1 caller (the owner) with an activated agent hears their own agent.
