-- Add comprehensive user language and workflow preferences
-- These settings provide per-user defaults for the application
...
-- Update existing users to have German defaults
UPDATE profiles 
SET 
