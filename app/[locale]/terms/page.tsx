    ...
    <div className="min-h-screen bg-white text-slate-900">
      ...
      <main className="max-w-4xl mx-auto px-6 py-16">
        ...
        <div className="space-y-10 text-slate-600 leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-semibold text-slate-900 mb-4">3. Beta Access</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-semibold text-slate-900 mb-4">7. Data Processing</h2>
            <p>
          ...
          <section>
            ...
            <p>
              ...
              <a href="mailto:legal@notissima.com" className="text-teal-600 hover:text-teal-500 underline underline-offset-2">
                legal@notissima.com
              </a>
            </p>
          </section>
